    ...
    return (
        <div className="max-w-[1520px] m-auto px-4 py-2 bg-[#24262b]">
            <div className="py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
                <div>
                    <h1 className="w-full text-3xl font-bold text-purple-500">XYZ</h1>
                    <p>
                        We provide services related to several technologies as we explained above
                        . We have the team of best Engineers who work hard to provide quality result 
                        in their field and we provide our customer a quality service, help them in business
                        and provide mentor.
                    </p>
